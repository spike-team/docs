# StudenTable OpenAPI Specification
[![Build Status](https://travis-ci.com/spike-team/docs.svg?branch=master)](https://travis-ci.com/spike-team/docs)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://spike-team.github.io/docs/)
- OpenAPI Raw Files: [JSON](https://spike-team.github.io/docs/openapi.json) [YAML](https://spike-team.github.io/docs/openapi.yaml)
